<div class="single-form-page-container flex">
    <div class="single-form-title bold" data-aos="leftSlideLong" data-aos-once="false" data-aos-duration="450"><span>Sign Up</span></div>
    ...
    <div class="contact-form-container">
        <form method='post' id='signup' action='/user/signup' class='form single-form-backslash' role='form' data-toggle="validator">
            <div class="has-feedback">
                <p class='field required half italic' data-aos="upSlideLong" data-aos-once="false">
                    ...
                    <input class='text-input' id='login' name='login' type='text' required>
                </p>
                <p class='field required half italic' data-aos="upSlideLong" data-aos-once="false">
                    <label class='label' for='password'>Password</label>
                    <input class='text-input' id='password' minlength="6" name='password' type="password" required>
                </p>
                <p class='field required italic' data-aos="upSlideLong" data-aos-once="false">
