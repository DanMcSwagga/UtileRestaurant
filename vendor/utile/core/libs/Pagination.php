...
class Pagination {
    ...
    public function getHtml() {
        ...
        return '<ul class="pagination" style="justify-content: center;">' . $startpage.$back.$page2left.$page1left.'<li class="active page-item"><a class=\'page-link\'>'.$this->currentPage.'</a></li>'.$page1right.$page2right.$forward.$endpage . '</ul>';
    }
